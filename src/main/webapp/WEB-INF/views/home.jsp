...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.html"><b>T<br>H<br>E</b>Coffee Shop<span>The Best Store In Town</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					 ...
					 <div onclick="location.href='<c:url value="/cart" />';"  class="cart" >
  ...
  <!---->
<div data-vide-bg=" <c:url value="/static/video/video"/>">
    <div class="container">
    ...
    <script>window.jQuery || document.write('<script src="<c:url value="/static/js/jquery-1.11.1.min.js" />"></script>')</script>
    
 <script src="<c:url value="/static/js/jquery.vide.min.js" />"></script>
				...
				<c:forEach items="${products}" var="product" varStatus="status">
                       <div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal17" class="offer-img">
										<img src="<c:url value="/static/images/of16.png"/>"   class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
